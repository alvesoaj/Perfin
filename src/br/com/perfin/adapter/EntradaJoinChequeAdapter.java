...
public class EntradaJoinChequeAdapter extends BaseAdapter{

	private Context context;
	private List<EntradaJoinCheque> lista;
			
	public EntradaJoinChequeAdapter(Context context, List<EntradaJoinCheque> lista) {
		super();
	...
	public long getItemId(int arg0) {
		return lista.get(arg0).getCheque().getId();
	}

	@Override
	public View getView(int arg0, View arg1, ViewGroup arg2) {
		EntradaJoinCheque entrada = lista.get(arg0);
