...
public class EntradaJoinRendaAdapter extends BaseAdapter{

	private Context context;
	private List<EntradaJoinRenda> lista;
			
	public EntradaJoinRendaAdapter(Context context, List<EntradaJoinRenda> lista) {
		super();
	...
	public long getItemId(int arg0) {
		return lista.get(arg0).getRenda().getId();
	}

	@Override
	public View getView(int arg0, View arg1, ViewGroup arg2) {
		EntradaJoinRenda entrada = lista.get(arg0);
